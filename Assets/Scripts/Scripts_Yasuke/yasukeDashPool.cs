...
public class yasukeDashPool : MonoBehaviour
{
    public static yasukeDashPool instance;

    public List<GameObject> pooledYasukes;
    [SerializeField] GameObject yasukeDashPrefab;
    public int yasukesToPool = 12;
    ...
    private void Awake()
    {
        ...
        PoolSetup(yasukeDashPrefab, pooledYasukes, yasukesToPool);
    }
